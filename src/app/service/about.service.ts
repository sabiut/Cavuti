...
export class AboutService{
    ...
    private about = new Array<AboutData>(
        ...
        { id: 5, title: "Aknowledgements", details: "Director, Department of Language and Culture – Mrs Marilyn Tagicakibau ( Namuka, Nakelo, Tailevu)iCavuti Data Coordinator/Analyst – Mr Simione Sevudredre ( Naburenivalu, Namena, Tailevu)", visible: true}
